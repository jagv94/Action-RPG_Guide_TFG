...
[Serializable]
public class UserEventBasicData
{
    ...
    public UserEventBasicData(string userID, string sessionID, string eventType, string targetObject,
        string cpu, string gpu, string ram, string os, string vr_headset)
    {
...
public class UserEventData
{
    ...
    [JsonProperty("helpAccessed")] public int helpAccessed; // true si el usuario ha abierto la sección de ayuda/controles.
    ...
    public UserEventData(string userID, string sessionID, string eventType, string targetObject, float duration,
        ...
        int teleportUsage, float fps, float cpuUsage, float gpuUsage, float ramUsage, int frustrationRate, int helpAccessed)
    {
        this.timestamp = DateTime.UtcNow.ToString("o");
        this.userID = userID;
        this.sessionID = sessionID;
